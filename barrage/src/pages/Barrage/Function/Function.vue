<template>
	<div>
		<transition
			enter-active-class="animate__animated animate__fadeInBottomRight animate_slow"
		...
		<ChangeName
			:isShowChangeName="sonFunctionState.isShowChangeName"
