<template>
    <div>
        ...
        <transition enter-active-class="animate__animated animate__slideInDown animate__faster"
            leave-active-class="animate__animated animate__slideOutUp animate__faster">
            <div class="smallVote " v-show="isSmall" @click="isSmall=false" ref="smallVote"
                :style="{'background':this.global.getIsSun()?'rgba(0, 0, 0, 0.478)':'linear-gradient(to right, #62605d 0%, #304352 100%)'}">
                投票
            </div>
        </transition>
